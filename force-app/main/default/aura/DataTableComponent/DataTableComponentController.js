({
    doInit : function(component, event, helper) {
     ...
     component.set('v.columns', [
            {label: 'Beer Order ID', fieldName: 'Name', type: 'text',editable:true},
            {label: 'Amount', fieldName: 'Order_Amount__c', type: 'text' ,editable:true},
            {label: 'Billing City', fieldName: 'Billing_City__c', type: 'text',editable:true},
            {label: 'Country', fieldName: 'Billing_Country__c', type: 'text',editable:true},
            {label: 'Postal Code', fieldName: 'Shipping_Postal_Code__c', type: 'text',editable:true},
